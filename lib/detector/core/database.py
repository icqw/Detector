...
from lib.detector.common.exceptions import DetectorDatabaseError
...
try:
    ...
    raise DetectorDependencyError("Unable to import sqlalchemy "
...
class Database(object):
    ...
    def __init__(self, dsn=None, schema_check=True, echo=False):
            ...
            if not os.path.exists(db_file):
                ...
                if not os.path.exists(db_dir):
                    try:
                        ...
                        raise DetectorDatabaseError("Unable to create database directory: {0}".format(e))
        ...
        try:
            ...
            raise DetectorDatabaseError("Unable to create or connect to database: {0}".format(e))
        ...
        if not tmp_session.query(AlembicVersion).count():
            ...
            try:
                ...
                raise DetectorDatabaseError("Unable to set schema version: {0}".format(e))
    ...
    def _connect_database(self, connection_string):
        ...
        try:
            ...
            raise DetectorDependencyError("Missing database driver, unable to "
    ...
    def lock_machine(self, label=None, platform=None, tags=None):
        ...
        try:
            ...
            if not machines.count():
                raise DetectorOperationalError("No machines match selection criteria.")
