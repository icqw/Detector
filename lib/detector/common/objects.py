...
from lib.detector.common.whitelist import is_whitelisted_domain
...
class File(object):
    ...
    YARA_RULEPATH = os.path.join(DETECTOR_ROOT, "data", "yara", "index_%s.yar")
    ...
    # thus we can cache them. If they are updated, one should restart Detector
