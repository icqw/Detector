...
# This file is part of Cuckoo Sandbox - http://www.detectorsandbox.org
...
class MITM(Auxiliary):
    ...
    def start(self):
        ...
        outpath = os.path.join(DETECTOR_ROOT, "storage", "analyses",
        ...
        mitmlog = os.path.join(DETECTOR_ROOT, "storage", "analyses",
                               "%d" % self.task.id, "mitm.log")

        mitmerr = os.path.join(DETECTOR_ROOT, "storage", "analyses",
