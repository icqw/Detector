...
from lib.detector.common.virustotal import VirusTotalAPI
from lib.detector.common.virustotal import VirusTotalResourceNotScanned
...
class VirusTotal(Processing):
    ...
    def run(self):
        ...
        if not apikey:
            raise DetectorProcessingError("VirusTotal API key not "
        ...
        if self.task["category"] == "file":
            ...
            raise DetectorProcessingError("Unsupported task category: %s" %
                                        self.task["category"])
